    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-v1-login">Login a user and create a token</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-register">
                                <a href="#authentication-POSTapi-v1-register">Register a new user and create a token</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-v1-logout">
                                <a href="#authentication-POSTapi-v1-logout">Logout a user and delete the token</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-v1-login">Login a user and create a token</h2>

<p>
</p>

<p>Authenticates a user using their email and password, and generates an API token for subsequent requests.</p>
...
<p>Must be at least 8 characters. Example: <code>+-0pBNvYgxwmi/#iw</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-register">Register a new user and create a token</h2>

<p>
</p>

<p>Creates a new user account and generates an API token for subsequent requests.</p>
...
<p>Must be at least 8 characters. Example: <code>NvYgxwmi/#iw/kX</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-logout">Logout a user and delete the token</h2>

<p>
</p>

<p>Signs out a user by deleting their current API token, effectively revoking access to protected endpoints.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="POSTapi-v1-tasks"
               value="architecto"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/tasks/2" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="PUTapi-v1-tasks--task_id-"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the users table. Example: <code>architecto</code></p>
